  ...
  getRandomTaskForPlayer(languageName, nickName) {
    ChallengeAPI.getRandomTaskForPlayerAPI(nickName, languageName, sessionStorage.getItem(JWT_TOKEN))
      .then(response => {
        ...
        this.setState({ input: response.data.preLoadedTask.input });
        this.setState({ output: response.data.preLoadedTask.output });
        this.setState({ compilerArgs: response.data.preLoadedTask.compilerArgs });
          ...
          <Form.Row>
            ...
            <Form.Group as={Col} md="7" controlId="validationCustom03">
              <Form.Control
                ...
                type="text"
                name="description"
                value={"Description : " + this.state.description + " Input : " + this.state.input + " Output : " + this.state.output + " Compiler Args : " + this.state.compilerArgs}
